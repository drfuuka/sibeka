                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex flex-column">
                            <h6 class="card-title">Tambah Data Siswa</h6>
                            <p class="text-muted mb-3">Tambahkan data siswa.</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('siswa.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alamat" rows="3" placeholder="Masukkan alamat siswa">{{ old('alamat') }}</textarea>
                            @error('alamat')
                                <small class="text-danger" role="alert">
                                    {{ $message }}
                                </small>
