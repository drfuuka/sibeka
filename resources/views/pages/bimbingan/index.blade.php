...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item" aria-current="page">Bimbingan</li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex flex-column">
                            <h6 class="card-title">Data Bimbingan Siswa</h6>
                            <p class="text-muted mb-3">List data bimbingan siswa.</p>
                        </div>
                        ...
                        <div class="d-flex gap-3 align-items-center">
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('bimbingan.cetak') }}" method="POST">
                                            @csrf
                            ...
                            @if (Auth::user()->role === 'BK')
                                <a class="btn btn-primary" href="{{ route('bimbingan.create') }}">Tambah</a>
                            @endif
                        </div>
                    </div>
