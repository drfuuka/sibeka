                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex flex-column">
                            <h6 class="card-title">Tambah Data Bimbingan</h6>
                            <p class="text-muted mb-3">Tambahkan data bimbingan siswa.</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('bimbingan.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="bimbingan" placeholder="Tuliskan bimbingan"
                                name="bimbingan" value="{{ old('bimbingan') }}">
                            @error('bimbingan')
                                <small class="text-danger" role="alert">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="solusi" placeholder="Tuliskan solusi"
                                name="solusi" value="{{ old('solusi') }}">
                            @error('solusi')
                                <small class="text-danger" role="alert">
                                    {{ $message }}
                                </small>
