                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex flex-column">
                            ...
                            <p class="text-muted mb-3">Ubah data guru.</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('guru.update', $user->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" data-width="100%" name="role">
                                ...
                                <option {{ old('role') === 'Guru' || $user->role === 'Guru' ? 'selected' : '' }}
                                    value="Guru">Guru</option>
                                <option {{ old('role') === 'BK' || $user->role === 'BK' ? 'selected' : '' }}
                                    value="BK">BK</option>
                                <option
                                    {{ old('role') === 'Kepala Sekolah' || $user->role === 'Kepala Sekolah' ? 'selected' : '' }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nip" placeholder="Masukkan nip guru"
                                name="nip" value="{{ old('nip') ?? $user->detail->nip }}">
                            @error('nip')
                                <small class="text-danger" role="alert">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no_hp" placeholder="Masukkan no hp guru"
                                name="no_hp" value="{{ old('no_hp') ?? $user->detail->no_hp }}">
                            @error('no_hp')
                                <small class="text-danger" role="alert">
                                    {{ $message }}
                                </small>
